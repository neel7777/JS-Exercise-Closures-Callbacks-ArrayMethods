...
function processSum(numberList, callback) {
    const totalSum = numberList.reduce(function(accumulator, element) {
...
function getFullNames(runners) {
    ...
    runners.forEach(element => {
        return names.push(`${element.last_name}, ${element.first_name}`)
    })
    return names;
}
...
function firstNamesAllCaps(runners) {
    const newArray = runners.map(element => {
...
function tallyUpDonations(runners) {
    let donation = runners.reduce(function(accumulator, element) {
